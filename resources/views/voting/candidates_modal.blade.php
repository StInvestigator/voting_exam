                    ...
                    <div class="d-flex" style="justify-content:space-between;">
                        ...
                        <div class="d-flex mx-2">
                            @if(Auth::user()->role == "Admin")
                                ...
                                <button data-id="{{$candidate->id}}" data-success-message="{{$candidate->first_name}} {{$candidate->last_name}} was successfully removed!"
                                    data-error-message="Something went wrong..."
                                    class="btn btn-outline-danger fs-5 my-auto px-4 candidate-remove"
                                    style="height:50px">Remove</button>
